                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="" id="deleteButtonAnggota" class="btn btn-outline-danger btn-sm d-inline-flex" data-bs-toggle="tooltip" data-bs-title="Hapus" aria-label="Hapus" onclick="confirmDelete('<?= $row['id_anggota']; ?>', 'anggota')">
