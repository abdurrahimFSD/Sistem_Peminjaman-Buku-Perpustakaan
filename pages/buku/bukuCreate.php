                ...
                <div class="card card-body">
                    ...
                    <form id="bukuCreateForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="tahunTerbit" id="tahunTerbit" class="form-control" placeholder="2020" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-4">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-danger mt-2" id="hapusFoto" style="display: none;">Hapus</button>
                        </div>
                        ...
                        <input type="hidden" name="simpan" value="bukuCreate">
